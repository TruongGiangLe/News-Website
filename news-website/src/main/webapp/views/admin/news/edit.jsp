...
<body>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<textarea rows="" cols="" id="content" name="content"
										style="width: 780px; height: 175px">${model.content}</textarea>
								</div>
							</div>
							<br /> <br />
							<div class="form-group">
	...
	$('#btnAddOrUpdateNew').click(function (e) {
		//tránh submit nhầm url, vì nó có thể submit nhầm vào url hiện tại thì sao?
		e.preventDefault();
		var data = {};
	...
	function addNews(data) {
		$.ajax({
			...
			// chuyển script object sang json 
			data:  JSON.stringify(data),
			// kiểu dữ liệu mà server trả về
			dataType: 'json',
